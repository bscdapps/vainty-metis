<template>
    <div class="panel">
        <p>
            Vainty Metis is an open source tool using your web browser to generate Metis vanity addresses.<br>
        ...
        <p>
            ...
            <b>Vainty Metis cannot and will never store your private key</b>, and if you don't trust it, you have 3 ways to ensure
            ...
            &nbsp;-&nbsp;You can also download the latest build of Vainty Metis
            ...
            <a href="" target="_blank">Github</a>. You can review it as much as you want before using it<br>
            <br>
            Vainty Metis uses a cryptographically secure pseudorandom number generator (CSPRNG) to generate
            Metis addresses.<br>
        ...
        <h2>Performance</h2>
        <p>
            For some reason, the performance of Vainty Metis can vary a lot from a browser to another.
            Currently, Chrome provides the best results.<br>
            Using Vainty Metis on your phone or tablet will work, but don't expect to reach the speed of a good old computer.
        </p>
        <h2>Compatibility</h2>
        <p>
            Any address generated with Vainty Metis is ERC-20 compatible, which means you can use it for an ICO, an
            airdrop, or just to withdraw your funds from an exchange.<br>
            The keystore file is 100% compatible with  MetaMask.
        </p>
    </div>
</template>
